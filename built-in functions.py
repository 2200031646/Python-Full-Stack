...
#max(),min(),sum()
'''print(max(8,7,5,9,10,20))

print(min(8,7,5,9,10,20))
...
'''a=[2,5,7,9,11,12,14,16,19,20]
b=[1,3,5,7,10,15,12,21,23,25]
c=list(map(max,a,b))
print(c)
c=list(map(min,a,b))
print(c)'''
...
print(a+b)'''
# Using map() with Different Collections
